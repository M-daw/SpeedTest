...
String url = 'gatoscuanticos.dx.am'
...
WebUI.takeScreenshot('Screenshots/' + todaysDate + '/' + todaysDate + '_' + nowTime + '_' + 'Mobile.png')
...
WebUI.takeScreenshot('Screenshots/' + todaysDate + '/' + todaysDate + '_' + nowTime + '_' + 'Desktop.png')
