...
5.times {
	...
	for (j=0; j<urls.length; j++){
		...
		CustomKeywords.'com.at.util.ScreenshotHelper.takeWebElementScreenshot'(findTestObject('PageSpeed Insights/main'), "${it}", j, 'mobile')
		...
		CustomKeywords.'com.at.util.ScreenshotHelper.takeWebElementScreenshot'(findTestObject('PageSpeed Insights/main'), "${it}", j, 'desktop')
